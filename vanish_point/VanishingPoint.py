...
def hough_transform(img):
    ...
    cv2.imwrite("C:/Users/naiti/Desktop/vanishingpoint/pictures/output/opening.jpg", opening)

    edges = cv2.Canny(opening, 50, 150, apertureSize=3)  # Canny edge detection
    cv2.imwrite("C:/Users/naiti/Desktop/vanishingpoint/pictures/output/canny.jpg", edges)
    ...
    cv2.imwrite("C:/Users/naiti/Desktop/vanishingpoint/pictures/output/hough.jpg", img)
    return hough_lines
...
def find_vanishing_point(img, grid_size, intersections):
    ...
    for i in xrange(grid_rows):
        for j in xrange(grid_columns):
            ...
            cv2.rectangle(img, (cell_left, cell_bottom), (cell_right, cell_top), (0, 123, 255), 4)
    ...
    if not best_cell == [None, None]:
        ...
        cv2.imwrite("C:/Users/naiti/Desktop/vanishingpoint/pictures/output/center.jpg", img)
	print best_cell
    return best_cell